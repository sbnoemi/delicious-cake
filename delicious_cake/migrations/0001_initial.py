...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'delicious_cake_apiaccess', (
        ...
        db.send_create_signal(u'delicious_cake', ['ApiAccess'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'delicious_cake_apiaccess')

        # Deleting model 'ApiKey'
        db.delete_table(u'delicious_cake_apikey')
    ...
    models = {
        ...
        u'delicious_cake.apikey': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'api_key'", 'unique': 'True', 'to': u"orm['sb_auth.SBUser']"})
        },
        u'sb_auth.sbuser': {
            'Meta': {'object_name': 'SBUser'},
